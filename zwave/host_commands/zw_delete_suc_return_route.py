...
from ..enums.host import delete_suc_return_route


class ZwDeleteSucReturnRoute(HOST_COMMAND):
    id = 0x55
...
class ZwDeleteSucReturnRouteResponse(HOST_RESPONSE):
    id = 0x55
...
class ZwDeleteSucReturnRouteCallback(HOST_CALLBACK):
    id = 0x55
