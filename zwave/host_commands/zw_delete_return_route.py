...
from ..enums.host import delete_return_route



class ZwDeleteReturnRoute(HOST_COMMAND):
    id = 0x47
...
class ZwDeleteReturnRouteResponse(HOST_RESPONSE):
    id = 0x47
...
class ZwDeleteReturnRouteCallback(HOST_CALLBACK):
