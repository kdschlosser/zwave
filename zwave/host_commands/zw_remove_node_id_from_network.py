...
from ..enums.host import remove_node_id_from_network
from ..command_classes import COMMAND_CLASS
from .. import zw_types


class ZwRemoveNodeIdFromNetwork(HOST_COMMAND):
    id = 0x3F
    ...
    modes = remove_node_id_from_network.command.mode
...
class ZwRemoveNodeIdFromNetworkCallback(HOST_CALLBACK):
    id = 0x3F
    ...
    statuses = remove_node_id_from_network.callback.status
