...
from ..enums.host import assign_priority_suc_return_route


class ZwAssignPrioritySucReturnRoute(HOST_COMMAND):
    id = 0x58
...
class ZwAssignPrioritySucReturnRouteResponse(HOST_RESPONSE):
    id = 0x58
...
class ZwAssignPrioritySucReturnRouteCallback(HOST_CALLBACK):
    id = 0x58
