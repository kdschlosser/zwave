...
from ..enums.host import create_new_primary
from ..command_classes import COMMAND_CLASS
from .. import zw_types


class ZwCreateNewPrimary(HOST_COMMAND):
    id = 0x4C
...
class ZwCreateNewPrimaryCallback(HOST_CALLBACK):
    id = 0x4C
    ...
    statuses = create_new_primary.callback.status
