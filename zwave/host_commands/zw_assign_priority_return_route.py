...
from ..enums.host import assign_priority_return_route


class ZwAssignPriorityReturnRoute(HOST_COMMAND):
    id = 0x4F
...
class ZwAssignPriorityReturnRouteResponse(HOST_RESPONSE):
    id = 0x4F
...
class ZwAssignPriorityReturnRouteCallback(HOST_CALLBACK):
    id = 0x4F
