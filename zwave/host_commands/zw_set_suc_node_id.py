...
from ..enums.host import set_suc_node_id


class ZwSetSucNodeId(HOST_COMMAND):
    id = 0x54
...
class ZwSetSucNodeIdResponse(HOST_RESPONSE):
    id = 0x54
...
class ZwSetSucNodeIdCallback(HOST_CALLBACK):
    id = 0x54
