...
from ..enums.host import replace_failed_node
from ..command_classes import COMMAND_CLASS
from .. import zw_types


class ZwReplaceFailedNode(HOST_COMMAND):
    id = 0x63
...
class ZwReplaceFailedNodeResponse(HOST_RESPONSE):
    id = 0x63
...
class ZwReplaceFailedNodeCallback(HOST_CALLBACK):
    id = 0x63
